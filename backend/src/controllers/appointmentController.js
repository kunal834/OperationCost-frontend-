...
//   try {
//     const patientQuery = await PatientQuery.find().sort({
//       created: -1,
//     });

//     const workbook = generateQueriesExcel(patientQuery);
...
//   try {
//     const patientQueries = await PatientQuery.find().sort({ createdAt: -1 });
